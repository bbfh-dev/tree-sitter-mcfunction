...
enum ts_symbol_identifiers {
  ...
  anon_sym_LBRACK = 61,
  aux_sym_snbt_array_token1 = 62,
  anon_sym_SEMI = 63,
  anon_sym_COMMA = 64,
  anon_sym_RBRACK = 65,
  anon_sym_LBRACE = 66,
  anon_sym_RBRACE = 67,
  aux_sym_key_token1 = 68,
  anon_sym_POUND_TILDE_GT = 69,
  anon_sym_POUND_COLON = 70,
  anon_sym_POUND_GT = 71,
  anon_sym_returnrun = 72,
  anon_sym_say = 73,
  anon_sym_execute = 74,
  anon_sym_run = 75,
  sym_source_file = 76,
  sym__statement = 77,
  sym__keywords = 78,
  sym_scoreboard_objective = 79,
  sym_scoreboard_display_slot = 80,
  sym_item_slot = 81,
  sym__item_slot_value = 82,
  sym__primitive_type = 83,
  sym_integer = 84,
  sym__number = 85,
  sym_hexadecimal = 86,
  sym_uuid = 87,
  sym__double_quoted_string = 88,
  sym__single_quoted_string = 89,
  sym_string = 90,
  sym_score_holder = 91,
  sym__composite_type = 92,
  sym_typed_number = 93,
  sym_vector = 94,
  sym_range = 95,
  sym_path = 96,
  sym__path_node = 97,
  sym__data_path_node = 98,
  sym__resource = 99,
  sym_minecraft_resource = 100,
  sym_generic_resource = 101,
  sym__resource_segment = 102,
  sym_snbt_array = 103,
  sym_snbt_compound = 104,
  sym_key = 105,
  sym__value = 106,
  sym_comment = 107,
  sym_command = 108,
  sym__execute_command = 109,
  sym__generic_command = 110,
  sym_command_identifier = 111,
  sym__command_argument = 112,
  aux_sym_source_file_repeat1 = 113,
  aux_sym__double_quoted_string_repeat1 = 114,
  aux_sym__single_quoted_string_repeat1 = 115,
  aux_sym_score_holder_repeat1 = 116,
  aux_sym_path_repeat1 = 117,
  aux_sym__data_path_node_repeat1 = 118,
  aux_sym_generic_resource_repeat1 = 119,
  aux_sym_snbt_array_repeat1 = 120,
  aux_sym_snbt_compound_repeat1 = 121,
  aux_sym__execute_command_repeat1 = 122,
  aux_sym__generic_command_repeat1 = 123,
  alias_sym_macro_sign = 124,
  alias_sym_namespace = 125,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(771);
    ...
    case 2:
      ...
      if (('A' <= lookahead && lookahead <= 'F')) ADVANCE(1472);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(771);
      if (('G' <= lookahead && lookahead <= '_') ||
          lookahead == 'z') ADVANCE(1473);
      END_STATE();
    case 3:
      ADVANCE_MAP(
        '\n', 716,
    ...
    case 5:
      ...
      if (('\t' <= lookahead && lookahead <= '\f')) ADVANCE(807);
    ...
    case 23:
      ...
      if (('A' <= lookahead && lookahead <= 'F') ||
          ('a' <= lookahead && lookahead <= 'e')) ADVANCE(1472);
      if (lookahead == '+' ||
          ('G' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(1473);
      END_STATE();
    case 24:
      ADVANCE_MAP(
        ' ', 24,
      ...
      if (lookahead == '+' ||
          ...
          lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1866);
      END_STATE();
    case 25:
      ADVANCE_MAP(
        ' ', 25,
      ...
      if (lookahead == '+' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(1473);
      END_STATE();
    case 26:
    ...
    case 27:
      ...
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(794);
    ...
    case 28:
      ...
      if (lookahead == '\\') ADVANCE(22);
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(801);
    ...
    case 31:
      ...
      if (lookahead == '+' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(1481);
      END_STATE();
    case 32:
    ...
    case 36:
      ...
      if (lookahead == '\\') ADVANCE(21);
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(57);
      if (set_contains(aux_sym_typed_number_token1_character_set_1, 11, lookahead)) ADVANCE(1483);
      END_STATE();
    case 37:
      if (lookahead == ' ') ADVANCE(37);
      if (lookahead == '\\') ADVANCE(21);
    ...
    case 40:
      ...
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(57);
      if (('a' <= lookahead && lookahead <= 'e')) ADVANCE(1472);
      if (('A' <= lookahead && lookahead <= 'F')) ADVANCE(1523);
      if (('1' <= lookahead && lookahead <= '9')) ADVANCE(771);
      if (('G' <= lookahead && lookahead <= 'Z')) ADVANCE(1521);
      if (lookahead == '+' ||
          lookahead == '_' ||
    ...
    case 201:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F')) ADVANCE(167);
      if (('g' <= lookahead && lookahead <= 'z')) ADVANCE(712);
      END_STATE();
    case 202:
      ACCEPT_TOKEN(sym__identifier);
    ...
    case 207:
      ...
      if (lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(712);
      if (('0' <= lookahead && lookahead <= '9') ||
    ...
    case 222:
      ...
      if (lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(712);
      END_STATE();
    case 223:
      ACCEPT_TOKEN(sym__identifier);
      if (lookahead == 'a') ADVANCE(649);
      if (lookahead == 's') ADVANCE(659);
      if (('b' <= lookahead && lookahead <= 'f')) ADVANCE(710);
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F')) ADVANCE(169);
      if (lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(712);
    ...
    case 837:
      ...
      if (lookahead == '+' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1473);
      END_STATE();
    case 838:
      ACCEPT_TOKEN(sym_word);
      if (lookahead == 'a') ADVANCE(744);
    ...
    case 839:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(1471);
      if (lookahead == '+' ||
          lookahead == '-' ||
          ('G' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
    ...
    case 860:
      ...
      if (lookahead == '+' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('c' <= lookahead && lookahead <= 'z')) ADVANCE(1473);
      END_STATE();
    case 861:
      ACCEPT_TOKEN(sym_word);
    ...
    case 866:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'F') ||
          ('b' <= lookahead && lookahead <= 'f')) ADVANCE(1470);
      if (lookahead == '+' ||
          lookahead == '-' ||
          ('G' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
    ...
    case 1538:
      ...
      if (lookahead == '+' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(1866);
      END_STATE();
    case 1539:
      ACCEPT_TOKEN(aux_sym_key_token1);
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(311)] = 9169,
  [SMALL_STATE(312)] = 9176,
  [SMALL_STATE(313)] = 9183,
  [SMALL_STATE(314)] = 9190,
  [SMALL_STATE(315)] = 9197,
};
