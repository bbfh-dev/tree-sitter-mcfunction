...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(1311);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '\n', 893,
    ...
    case 7:
      ...
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(2064);
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(511);
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(1308);
      if (('!' <= lookahead && lookahead <= '#') ||
          lookahead == ':' ||
          ('A' <= lookahead && lookahead <= 'Z')) ADVANCE(2079);
      END_STATE();
    case 8:
      ...
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(1308);
      if (lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(2064);
      if (('!' <= lookahead && lookahead <= '#') ||
          lookahead == ':' ||
          ('A' <= lookahead && lookahead <= 'Z')) ADVANCE(2079);
      END_STATE();
    ...
    case 888:
      ...
      END_STATE();
    case 889:
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(1286);
      END_STATE();
    case 890:
      if (lookahead == '/' ||
          lookahead == '_' ||
    ...
    case 1121:
      ...
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(2064);
      if (lookahead == '!' ||
          lookahead == '#' ||
          lookahead == '+' ||
          lookahead == '.' ||
    ...
    case 1404:
      ...
      if (lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2064);
      if (lookahead == '!' ||
          lookahead == '#' ||
          lookahead == '+' ||
          lookahead == '.' ||
    ...
    case 2066:
      ...
      if (lookahead == '!' ||
          ...
          ('A' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2079);
      END_STATE();
    case 2067:
      ACCEPT_TOKEN(aux_sym_word_token1);
      if (lookahead == 'c') ADVANCE(2073);
      if (lookahead == '!' ||
          lookahead == '#' ||
          lookahead == '+' ||
          lookahead == '.' ||
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [STATE(0)] = {
    ...
    [anon_sym_PERCENT_LBRACK] = ACTIONS(7),
  ...
  [STATE(1)] = {
    ...
    [sym_command_identifier] = STATE(149),
    [sym_macro] = STATE(1),
    ...
    [sym_backslash] = ACTIONS(3),
    [aux_sym__statement_token1] = ACTIONS(13),
    [sym_comment] = ACTIONS(15),
    [anon_sym_execute] = ACTIONS(17),
    [sym_macro_indicator] = ACTIONS(19),
    [anon_sym_advancement] = ACTIONS(21),
    [anon_sym_attribute] = ACTIONS(21),
    [anon_sym_ban] = ACTIONS(23),
    [anon_sym_ban_DASHip] = ACTIONS(21),
    [anon_sym_banlist] = ACTIONS(21),
    [anon_sym_bossbar] = ACTIONS(21),
    [anon_sym_clear] = ACTIONS(21),
    [anon_sym_clone] = ACTIONS(21),
    [anon_sym_damage] = ACTIONS(21),
    [anon_sym_data] = ACTIONS(23),
    [anon_sym_datapack] = ACTIONS(21),
    [anon_sym_debug] = ACTIONS(21),
    [anon_sym_defaultgamemode] = ACTIONS(21),
    [anon_sym_deop] = ACTIONS(21),
    [anon_sym_dialog] = ACTIONS(21),
    [anon_sym_difficulty] = ACTIONS(21),
    [anon_sym_effect] = ACTIONS(21),
    [anon_sym_enchant] = ACTIONS(21),
    [anon_sym_experience] = ACTIONS(21),
    [anon_sym_fetchprofile] = ACTIONS(21),
    [anon_sym_fill] = ACTIONS(23),
    [anon_sym_fillbiome] = ACTIONS(21),
    [anon_sym_forceload] = ACTIONS(21),
    [anon_sym_function] = ACTIONS(21),
    [anon_sym_gamemode] = ACTIONS(21),
    [anon_sym_gamerule] = ACTIONS(21),
    [anon_sym_give] = ACTIONS(21),
    [anon_sym_help] = ACTIONS(21),
    [anon_sym_item] = ACTIONS(21),
    [anon_sym_jfr] = ACTIONS(21),
    [anon_sym_kick] = ACTIONS(21),
    [anon_sym_kill] = ACTIONS(21),
    [anon_sym_list] = ACTIONS(21),
    [anon_sym_locate] = ACTIONS(21),
    [anon_sym_loot] = ACTIONS(21),
    [anon_sym_me] = ACTIONS(21),
    [anon_sym_msg] = ACTIONS(21),
    [anon_sym_op] = ACTIONS(21),
    [anon_sym_pardon] = ACTIONS(23),
    [anon_sym_pardon_DASHip] = ACTIONS(21),
    [anon_sym_particle] = ACTIONS(21),
    [anon_sym_perf] = ACTIONS(21),
    [anon_sym_place] = ACTIONS(21),
    [anon_sym_playsound] = ACTIONS(21),
    [anon_sym_publish] = ACTIONS(21),
    [anon_sym_random] = ACTIONS(21),
    [anon_sym_recipe] = ACTIONS(21),
    [anon_sym_reload] = ACTIONS(21),
    [anon_sym_return] = ACTIONS(21),
    [anon_sym_ride] = ACTIONS(21),
    [anon_sym_rotate] = ACTIONS(21),
    [anon_sym_save_DASHall] = ACTIONS(21),
    [anon_sym_save_DASHoff] = ACTIONS(21),
    [anon_sym_save_DASHon] = ACTIONS(21),
    [anon_sym_say] = ACTIONS(21),
    [anon_sym_schedule] = ACTIONS(21),
    [anon_sym_scoreboard] = ACTIONS(21),
    [anon_sym_seed] = ACTIONS(21),
    [anon_sym_setblock] = ACTIONS(21),
    [anon_sym_setidletimeout] = ACTIONS(21),
    [anon_sym_setworldspawn] = ACTIONS(21),
    [anon_sym_spawnpoint] = ACTIONS(21),
    [anon_sym_spectate] = ACTIONS(21),
    [anon_sym_spreadplayers] = ACTIONS(21),
    [anon_sym_stop] = ACTIONS(23),
    [anon_sym_stopsound] = ACTIONS(21),
    [anon_sym_summon] = ACTIONS(21),
    [anon_sym_swing] = ACTIONS(21),
    [anon_sym_tag] = ACTIONS(21),
    [anon_sym_team] = ACTIONS(23),
    [anon_sym_teammsg] = ACTIONS(21),
    [anon_sym_teleport] = ACTIONS(21),
    [anon_sym_tell] = ACTIONS(23),
    [anon_sym_tellraw] = ACTIONS(21),
    [anon_sym_test] = ACTIONS(21),
    [anon_sym_time] = ACTIONS(21),
    [anon_sym_title] = ACTIONS(21),
    [anon_sym_tm] = ACTIONS(21),
    [anon_sym_tp] = ACTIONS(21),
    [anon_sym_transfer] = ACTIONS(21),
    [anon_sym_trigger] = ACTIONS(21),
    [anon_sym_version] = ACTIONS(21),
    [anon_sym_w] = ACTIONS(23),
    [anon_sym_waypoint] = ACTIONS(21),
    [anon_sym_weather] = ACTIONS(21),
    [anon_sym_whitelist] = ACTIONS(21),
    [anon_sym_worldborder] = ACTIONS(21),
    [anon_sym_xp] = ACTIONS(21),
    [anon_sym_DOLLAR_LPAREN] = ACTIONS(5),
    [anon_sym_PERCENT_LBRACK] = ACTIONS(7),
  },
  [STATE(2)] = {
    [sym_argument] = STATE(197),
    [sym_selector] = STATE(196),
    [sym_position] = STATE(196),
    [sym_rotation] = STATE(196),
    [sym_scale] = STATE(196),
    [sym_macro] = STATE(2),
    [sym_substitution] = STATE(2),
    [sym_operator] = STATE(196),
    [sym_slot] = STATE(196),
    [sym_word] = STATE(196),
    [sym_string] = STATE(196),
    [sym_nbt_compound] = STATE(196),
    [sym_nbt_array] = STATE(196),
    [sym_backslash] = ACTIONS(3),
    [anon_sym_run] = ACTIONS(25),
    [anon_sym_clear] = ACTIONS(25),
    [anon_sym_damage] = ACTIONS(25),
    [anon_sym_function] = ACTIONS(25),
    [anon_sym_give] = ACTIONS(25),
    [anon_sym_list] = ACTIONS(25),
    [anon_sym_locate] = ACTIONS(25),
    [anon_sym_reload] = ACTIONS(25),
    [anon_sym_stop] = ACTIONS(25),
    [anon_sym_time] = ACTIONS(25),
    [anon_sym_at] = ACTIONS(25),
    [anon_sym_biome] = ACTIONS(25),
    [anon_sym_block] = ACTIONS(25),
    [anon_sym_blocks] = ACTIONS(25),
    [anon_sym_entity] = ACTIONS(25),
    [anon_sym_facing] = ACTIONS(25),
    [anon_sym_max] = ACTIONS(25),
    [anon_sym_on] = ACTIONS(25),
    [anon_sym_storage] = ACTIONS(25),
    [anon_sym_value] = ACTIONS(25),
    [anon_sym_add] = ACTIONS(25),
    [anon_sym_add_multiplied_base] = ACTIONS(25),
    [anon_sym_add_multiplied_total] = ACTIONS(25),
    [anon_sym_add_value] = ACTIONS(25),
    [anon_sym_amount] = ACTIONS(25),
    [anon_sym_append] = ACTIONS(25),
    [anon_sym_base] = ACTIONS(25),
    [anon_sym_buffer] = ACTIONS(25),
    ...
    [anon_sym_daytime] = ACTIONS(25),
    [anon_sym_destroy] = ACTIONS(25),
    [anon_sym_disable] = ACTIONS(25),
    [anon_sym_dismount] = ACTIONS(25),
    [anon_sym_distance] = ACTIONS(25),
    [anon_sym_enable] = ACTIONS(25),
    [anon_sym_everything] = ACTIONS(25),
    [anon_sym_export] = ACTIONS(25),
    [anon_sym_exportclosest] = ACTIONS(25),
    [anon_sym_exportthat] = ACTIONS(25),
    [anon_sym_exportthese] = ACTIONS(25),
    [anon_sym_fail] = ACTIONS(25),
    [anon_sym_feature] = ACTIONS(25),
    [anon_sym_fish] = ACTIONS(25),
    [anon_sym_flush] = ACTIONS(25),
    [anon_sym_force] = ACTIONS(25),
    [anon_sym_from] = ACTIONS(25),
    [anon_sym_gametime] = ACTIONS(25),
    [anon_sym_get] = ACTIONS(25),
    [anon_sym_grant] = ACTIONS(25),
    [anon_sym_hollow] = ACTIONS(25),
    [anon_sym_id] = ACTIONS(25),
    [anon_sym_insert] = ACTIONS(25),
    [anon_sym_ips] = ACTIONS(25),
    [anon_sym_jigsaw] = ACTIONS(25),
    [anon_sym_join] = ACTIONS(25),
    [anon_sym_keep] = ACTIONS(25),
    [anon_sym_leave] = ACTIONS(25),
    [anon_sym_levels] = ACTIONS(25),
    [anon_sym_mainhand] = ACTIONS(25),
    [anon_sym_merge] = ACTIONS(25),
    [anon_sym_midnight] = ACTIONS(25),
    [anon_sym_mine] = ACTIONS(25),
    [anon_sym_modifier] = ACTIONS(25),
    [anon_sym_modify] = ACTIONS(25),
    [anon_sym_mount] = ACTIONS(25),
    [anon_sym_move] = ACTIONS(25),
    [anon_sym_name] = ACTIONS(25),
    [anon_sym_night] = ACTIONS(25),
    [anon_sym_noon] = ACTIONS(25),
    [anon_sym_normal] = ACTIONS(25),
    [anon_sym_objectives] = ACTIONS(25),
    [anon_sym_off] = ACTIONS(25),
    [anon_sym_offhand] = ACTIONS(25),
    [anon_sym_only] = ACTIONS(25),
    [anon_sym_outline] = ACTIONS(25),
    [anon_sym_players] = ACTIONS(25),
    [anon_sym_poi] = ACTIONS(25),
    [anon_sym_points] = ACTIONS(25),
    [anon_sym_pos] = ACTIONS(25),
    [anon_sym_prepend] = ACTIONS(25),
    [anon_sym_query] = ACTIONS(25),
    [anon_sym_rain] = ACTIONS(25),
    [anon_sym_remove] = ACTIONS(25),
    [anon_sym_replace] = ACTIONS(25),
    [anon_sym_reset] = ACTIONS(25),
    [anon_sym_resetclosest] = ACTIONS(25),
    [anon_sym_resetthat] = ACTIONS(25),
    [anon_sym_resetthese] = ACTIONS(25),
    [anon_sym_revoke] = ACTIONS(25),
    [anon_sym_roll] = ACTIONS(25),
    [anon_sym_runclosest] = ACTIONS(25),
    [anon_sym_runfailed] = ACTIONS(25),
    [anon_sym_runthat] = ACTIONS(25),
    [anon_sym_runthese] = ACTIONS(25),
    [anon_sym_set] = ACTIONS(25),
    [anon_sym_setdisplay] = ACTIONS(25),
    ...
    [anon_sym_GT_LT] = ACTIONS(37),
    [anon_sym_LT] = ACTIONS(37),
    [anon_sym_GT] = ACTIONS(39),
    [aux_sym_slot_token1] = ACTIONS(41),
    [aux_sym_slot_token2] = ACTIONS(41),
    [aux_sym_slot_token3] = ACTIONS(41),
    [aux_sym_slot_token4] = ACTIONS(41),
    [aux_sym_slot_token5] = ACTIONS(41),
    [aux_sym_slot_token6] = ACTIONS(41),
    [aux_sym_slot_token7] = ACTIONS(41),
    [anon_sym_contents] = ACTIONS(41),
    [anon_sym_player_DOTcursor] = ACTIONS(41),
    [aux_sym_slot_token8] = ACTIONS(41),
  ...
  [STATE(13)] = {
    [sym__execute_command] = STATE(213),
    [sym__generic_command] = STATE(213),
    [sym_command_identifier] = STATE(149),
    [sym_macro] = STATE(13),
  ...
  [STATE(15)] = {
    [sym__subcommand] = STATE(215),
    [sym_subcommand_identifier] = STATE(229),
    [sym_selector] = STATE(229),
    [sym_position] = STATE(229),
    [sym_rotation] = STATE(229),
    [sym_scale] = STATE(229),
    [sym_macro] = STATE(15),
    [sym_substitution] = STATE(15),
    [sym_operator] = STATE(229),
    [sym_slot] = STATE(229),
    [sym_word] = STATE(229),
    [sym_string] = STATE(229),
    [sym_nbt_compound] = STATE(229),
    [sym_nbt_array] = STATE(229),
    [sym_backslash] = ACTIONS(3),
...
static const uint32_t ts_small_parse_table_map[] = {
  ...
  [SMALL_STATE(131)] = 4205,
  [SMALL_STATE(132)] = 4234,
  [SMALL_STATE(133)] = 4255,
  [SMALL_STATE(134)] = 4276,
  [SMALL_STATE(135)] = 4297,
  [SMALL_STATE(136)] = 4318,
  ...
  [SMALL_STATE(182)] = 5342,
  [SMALL_STATE(183)] = 5361,
  [SMALL_STATE(184)] = 5380,
  [SMALL_STATE(185)] = 5399,
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [65] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(226),
  [68] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(180),
  ...
  [84] = {.entry = {.count = 1, .reusable = true}}, SHIFT(218),
  [86] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__statement, 3, 0, 0),
  [88] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__statement, 3, 0, 0),
  ...
  [104] = {.entry = {.count = 1, .reusable = false}}, SHIFT(212),
  [106] = {.entry = {.count = 1, .reusable = false}}, SHIFT(229),
  ...
  [122] = {.entry = {.count = 1, .reusable = false}}, SHIFT(228),
  ...
  [142] = {.entry = {.count = 1, .reusable = false}}, SHIFT(181),
  [144] = {.entry = {.count = 1, .reusable = false}}, SHIFT(175),
  [146] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  [149] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0), SHIFT_REPEAT(26),
  [152] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0),
  [154] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0),
  [156] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_query_repeat1, 1, 0, 0),
  [158] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_query_repeat1, 1, 0, 0),
  ...
  [172] = {.entry = {.count = 1, .reusable = true}}, SHIFT(247),
  ...
  [190] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [193] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [196] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(60),
  [199] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(256),
  [202] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(38),
  [205] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(246),
  [208] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(247),
  [211] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(63),
  [214] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(93),
  [217] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 2, 0, 0), SHIFT_REPEAT(33),
  ...
  [232] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scale, 1, 0, 0),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scale, 1, 0, 0),
  [236] = {.entry = {.count = 1, .reusable = false}}, SHIFT(64),
  [238] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [240] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scale, 2, 0, 0),
  [242] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scale, 2, 0, 0),
  ...
  [252] = {.entry = {.count = 1, .reusable = false}}, SHIFT(221),
  ...
  [266] = {.entry = {.count = 1, .reusable = false}}, SHIFT(234),
  ...
  [280] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  [283] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0), SHIFT_REPEAT(53),
  ...
  [296] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nbt_array, 3, 0, 0),
  [298] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nbt_array, 3, 0, 0),
  [300] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nbt_compound, 3, 0, 0),
  [302] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nbt_compound, 3, 0, 0),
  [304] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_nbt_array_repeat1, 1, 0, 0),
  [306] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_nbt_array_repeat1, 1, 0, 0),
  [308] = {.entry = {.count = 1, .reusable = false}}, SHIFT(133),
  [310] = {.entry = {.count = 1, .reusable = false}}, SHIFT(129),
  [312] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__nbt_element, 1, 0, 0),
  [314] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__nbt_element, 1, 0, 0),
  [316] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nbt_compound, 2, 0, 0),
  [318] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nbt_compound, 2, 0, 0),
  [320] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nbt_array, 2, 0, 0),
  [322] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nbt_array, 2, 0, 0),
  [324] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_scale, 3, 0, 0),
  [326] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_scale, 3, 0, 0),
  ...
  [344] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_word, 1, 0, 0),
  [346] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word, 1, 0, 0),
  [348] = {.entry = {.count = 1, .reusable = true}}, SHIFT(81),
  [350] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [352] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 1, 0, 0),
  [354] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_item_compound_repeat1, 1, 0, 0),
  ...
  [374] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(109),
  [377] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(152),
  [380] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(227),
  [383] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(214),
  [386] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_selector_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(186),
  [389] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 2, 0, 0),
  ...
  [401] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(108),
  [404] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(71),
  [407] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(248),
  [410] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(249),
  [413] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_item_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(87),
  [416] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 2, 0, 0),
  ...
  [432] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_word, 2, 0, 0),
  [434] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word, 2, 0, 0),
  [436] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_nbt_identifier, 1, 0, 0),
  [438] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_nbt_identifier, 1, 0, 0),
  [440] = {.entry = {.count = 1, .reusable = true}}, SHIFT(207),
  [442] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(141),
  [445] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(244),
  [448] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(245),
  [451] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 2, 0, 0), SHIFT_REPEAT(186),
  ...
  [468] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 1, 0, 0), REDUCE(aux_sym_selector_compound_repeat1, 1, 0, 0),
  [471] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 1, 0, 0),
  [473] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_nbt_compound_repeat1, 1, 0, 0), REDUCE(aux_sym_selector_compound_repeat1, 1, 0, 0),
  [476] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 3, 0, 0),
  [478] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_item_compound_repeat1, 3, 0, 0),
  [480] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_rotation, 1, 0, 0),
  [482] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_rotation, 1, 0, 0),
  [484] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_compound_repeat1, 1, 0, 0),
  [486] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 4, 0, 0),
  [488] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_compound_repeat1, 4, 0, 0),
  [490] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_item_compound_repeat1, 4, 0, 0),
  [492] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_item_compound_repeat1, 4, 0, 0),
  [494] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item_compound, 2, 0, 0),
  [496] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_compound, 2, 0, 0),
  ...
  [502] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 5, 0, 0),
  [504] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_compound_repeat1, 5, 0, 0),
  ...
  [512] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item_compound, 3, 0, 0),
  [514] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_compound_repeat1, 3, 0, 0),
  [516] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_selector_compound_repeat1, 3, 0, 0),
  [518] = {.entry = {.count = 1, .reusable = false}}, SHIFT(22),
  [520] = {.entry = {.count = 1, .reusable = true}}, SHIFT(22),
  [522] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 4, 0, 0),
  [524] = {.entry = {.count = 1, .reusable = true}}, SHIFT(235),
  [526] = {.entry = {.count = 1, .reusable = true}}, SHIFT(84),
  [528] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 3, 0, 0),
  ...
  [544] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word, 3, 0, 0),
  [546] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0), SHIFT_REPEAT(167),
  [549] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_query_repeat1, 2, 0, 0), SHIFT_REPEAT(167),
  [552] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 5, 0, 0),
  [554] = {.entry = {.count = 1, .reusable = true}}, SHIFT(43),
  [556] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [558] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_nbt_compound_repeat1, 1, 0, 0),
  [560] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_repeat1, 2, 0, 0),
  [562] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_selector_repeat1, 2, 0, 0), SHIFT_REPEAT(130),
  ...
  [575] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__generic_command, 2, 0, 0),
  [577] = {.entry = {.count = 1, .reusable = false}}, SHIFT(3),
  [579] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [581] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__generic_command, 1, 0, 0),
  ...
  [595] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector, 1, 0, 0),
  [597] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_compound, 3, 0, 0),
  ...
  [607] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym__execute_command_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  [610] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__execute_command_repeat1, 2, 0, 0), SHIFT_REPEAT(19),
  ...
  [619] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_query, 3, 0, 0),
  [621] = {.entry = {.count = 1, .reusable = true}}, SHIFT(194),
  [623] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_nbt_compound, 2, 0, 0), REDUCE(sym_selector_compound, 2, 0, 0),
  [626] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_selector, 1, 0, 0),
  [628] = {.entry = {.count = 1, .reusable = true}}, SHIFT(150),
  [630] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_operator, 1, 0, 0),
  [632] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_query, 5, 0, 0),
  [634] = {.entry = {.count = 1, .reusable = true}}, SHIFT(209),
  [636] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_slot, 1, 0, 0),
  [638] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_query, 4, 0, 0),
  ...
  [648] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_slot, 1, 0, 0),
  [650] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_selector, 3, 0, 0),
  [652] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_selector_repeat1, 1, 0, 0),
  [654] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_argument, 1, 0, 0),
  [656] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_argument, 1, 0, 0),
  [658] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__generic_command_repeat1, 2, 0, 0),
  [660] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command_identifier, 1, 0, 0),
  [662] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_command_identifier, 1, 0, 0),
  ...
  [670] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_selector_query, 6, 0, 0),
  [672] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_word, 4, 0, 0),
  [674] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [676] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_subcommand_identifier, 1, 0, 0),
  [678] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_subcommand_identifier, 1, 0, 0),
  [680] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 2, 0, 0),
  [682] = {.entry = {.count = 1, .reusable = false}}, SHIFT_EXTRA(),
  [684] = {.entry = {.count = 1, .reusable = false}}, SHIFT(223),
  [686] = {.entry = {.count = 1, .reusable = false}}, SHIFT(239),
  [688] = {.entry = {.count = 1, .reusable = false}}, SHIFT(233),
  [690] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym__execute_command_repeat1, 2, 0, 0),
  [692] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__execute_command_repeat1, 2, 0, 0),
  [694] = {.entry = {.count = 1, .reusable = true}}, SHIFT(166),
  [696] = {.entry = {.count = 1, .reusable = false}}, SHIFT(7),
  [698] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__execute_command, 6, 0, 0),
  ...
  [708] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__execute_command, 5, 0, 0),
  [710] = {.entry = {.count = 1, .reusable = false}}, SHIFT(232),
  [712] = {.entry = {.count = 1, .reusable = true}}, SHIFT(79),
  [714] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__subcommand, 1, 0, 0),
  [716] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__subcommand, 1, 0, 0),
  ...
  [728] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_command, 1, 0, 0),
  ...
  [738] = {.entry = {.count = 1, .reusable = false}}, SHIFT(217),
  ...
  [750] = {.entry = {.count = 1, .reusable = false}}, SHIFT(237),
  [752] = {.entry = {.count = 1, .reusable = false}}, SHIFT(240),
  [754] = {.entry = {.count = 1, .reusable = false}}, SHIFT(241),
  ...
  [762] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_macro, 3, 0, 0),
  [764] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_substitution, 2, 0, 0),
};
