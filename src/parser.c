...
enum ts_symbol_identifiers {
  ...
  anon_sym_SQUOTE_DQUOTE = 283,
  anon_sym_DQUOTE_SQUOTE = 284,
  sym_boolean = 285,
  sym_range = 286,
  ...
  sym_rotation = 306,
  sym_scale = 307,
  sym_substitution = 308,
  sym_operator = 309,
  sym_slot = 310,
  sym_word = 311,
  sym_string = 312,
  sym__nbt_element = 313,
  sym_nbt_identifier = 314,
  sym_nbt_compound = 315,
  sym_nbt_array = 316,
  sym_selector_compound = 317,
  sym_item_compound = 318,
  aux_sym_source_file_repeat1 = 319,
  aux_sym__execute_command_repeat1 = 320,
  aux_sym__generic_command_repeat1 = 321,
  aux_sym_selector_repeat1 = 322,
  aux_sym_selector_query_repeat1 = 323,
  aux_sym_string_repeat1 = 324,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(1315);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        '\n', 897,
    ...
    case 7:
      ...
      if (lookahead == '_' ||
          ('x' <= lookahead && lookahead <= 'z')) ADVANCE(2066);
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(514);
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(1312);
      if (('!' <= lookahead && lookahead <= '#') ||
          lookahead == ':' ||
          ('A' <= lookahead && lookahead <= 'Z')) ADVANCE(2080);
      END_STATE();
    case 8:
      ...
      if (('2' <= lookahead && lookahead <= '9')) ADVANCE(1312);
      if (lookahead == '_' ||
          ('g' <= lookahead && lookahead <= 'z')) ADVANCE(2066);
      if (('!' <= lookahead && lookahead <= '#') ||
          lookahead == ':' ||
          ('A' <= lookahead && lookahead <= 'Z')) ADVANCE(2080);
      END_STATE();
    ...
    case 10:
      ...
      if (('\t' <= lookahead && lookahead <= '\r')) ADVANCE(24);
      if (lookahead == '_' ||
          ('a' <= lookahead && lookahead <= 'z')) ADVANCE(2103);
      if (('!' <= lookahead && lookahead <= '#') ||
          ('+' <= lookahead && lookahead <= '-') ||
          ('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z')) ADVANCE(2104);
      END_STATE();
    case 11:
      ADVANCE_MAP(
        '"', 2081,
    ...
    case 17:
      ...
      if (lookahead != 0 &&
          (lookahead < '\'' || ')' < lookahead)) ADVANCE(2087);
      END_STATE();
    case 18:
      if (lookahead == '$') ADVANCE(22);
      if (lookahead == '%') ADVANCE(513);
    ...
    case 25:
      ...
      if (('0' <= lookahead && lookahead <= '9')) ADVANCE(2101);
      END_STATE();
    case 26:
    ...
    case 888:
      if (lookahead == '*' ||
          ('0' <= lookahead && lookahead <= '9')) ADVANCE(1361);
      END_STATE();
    case 889:
      if (lookahead == '*' ||
          ('0' <= lookahead && lookahead <= '9')) ADVANCE(1365);
      END_STATE();
    case 890:
      if (lookahead == '*' ||
          ('0' <= lookahead && lookahead <= '9')) ADVANCE(1367);
      END_STATE();
    case 891:
      if (lookahead == '*' ||
    ...
    case 903:
      ...
      if (lookahead != 0 &&
          lookahead != '"' &&
          lookahead != '$' &&
          (lookahead < '\'' || ')' < lookahead)) ADVANCE(2095);
      END_STATE();
    case 904:
    ...
    case 1125:
      ...
      if (('a' <= lookahead && lookahead <= 'z')) ADVANCE(2066);
      if (lookahead == '!' ||
          lookahead == '#' ||
          lookahead == '+' ||
          lookahead == '.' ||
    ...
    case 1363:
      ACCEPT_TOKEN(aux_sym_slot_token2);
      if (lookahead == '*' ||
          ('0' <= lookahead && lookahead <= '9')) ADVANCE(1363);
      END_STATE();
    case 1364:
    ...
    case 1406:
      ...
      if (lookahead == '_' ||
          ('b' <= lookahead && lookahead <= 'z')) ADVANCE(2066);
      if (lookahead == '!' ||
          lookahead == '#' ||
          lookahead == '+' ||
          lookahead == '.' ||
